...
function App() {
  ...
  const getPageTitle = () => {
    switch (activeTab) {
      case 'command-center': return 'Centro de Mando';
      case 'growth': return 'Crecimiento';
      case 'attention-content': return 'Atención y Contenido';
      case 'operations': return 'Operaciones';
      case 'quality-risk': return 'Calidad y Riesgo';
      case 'financial-control': return 'Control Financiero';
      case 'geography-intelligence': return 'Inteligencia Geográfica';
      case 'users-restaurants': return 'Usuarios y Restaurantes';
  ...
  return (
    <Routes>
      <Route path="/" element={<LandingPage 
        onUserLoginClick={() => navigate('/login')} 
      ...
      <Route path="/rider" element={<RiderLandingPage onBack={() => navigate('/')} onRegisterClick={() => navigate('/rider/registration')} onLoginClick={() => navigate('/rider/login')} />} />
      <Route path="/rider/registration" element={<RiderRegistration onBack={() => navigate('/rider')} />} />
      <Route path="/rider/login" element={<UserAuth onLogin={() => navigate('/rider')} onBack={() => navigate('/rider')} variant="rider" onResumeRegistration={(data) => { setResumeData(data); navigate('/rider/registration/resume'); }} />} />
      <Route path="/rider/registration/resume" element={<RiderRegistration onBack={() => navigate('/rider')} initialData={resumeData} />} />
      
      <Route path="/restaurant" element={<RestaurantLandingPage onBack={() => navigate('/')} onLoginClick={() => navigate('/restaurant/login')} />} />
      <Route path="/restaurant/registration" element={<RestaurantRegistration onBack={() => navigate('/restaurant')} />} />
      <Route path="/restaurant/login" element={<UserAuth onLogin={() => navigate('/restaurant')} onBack={() => navigate('/restaurant')} variant="restaurant" onResumeRegistration={(data) => { setResumeData(data); navigate('/restaurant/registration/resume'); }} />} />
      <Route path="/restaurant/registration/resume" element={<RestaurantRegistration onBack={() => navigate('/restaurant')} initialData={resumeData} />} />
      
      <Route path="/banners-manager" element={<BannerManagerPage />} />
